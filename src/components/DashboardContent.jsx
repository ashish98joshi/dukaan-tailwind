...
export const DashboardContent = () => {
    return <div className="px-3 py-3 sm:px-6 sm:py-7 w-full gap-6 flex flex-col bg-gray-100">
        <div className="flex justify-between">
            ...
            <div className="flex gap-2 px-3 py-2 bg-white rounded justify-end text-[#4D4D4D] items-center border ">
        ...
        <div className="flex gap-4 flex-wrap justify-between">
            ...
            <div className="flex-grow rounded-[8px] bg-white flex flex-col gap-4 shadow-sm h-fit">
                <span className="text-black flex items-center px-4 py-2 pb-1 gap-2 text-lg">
                    Amount Pending
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.0} stroke="currentColor" className="w-4 h-4">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 5.25h.008v.008H12v-.008Z" />
                    </svg>
                ...
                <div className="px-4 flex items-center justify-between text-black ">
                    <p className="text-3xl font-medium pb-5 justify-between items-center">₹92,312.20</p>
                    <p className="flex underline font-medium gap-x-px text-[#146EB4]">13 Orders 
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.0} stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                        </svg>
                    </p>
            ...
            <div className="flex-grow rounded-[8px] bg-white flex flex-col gap-4 shadow-sm h-fit">
                ...
                <div className="px-4 flex items-center justify-between text-black ">
                    <p className="text-3xl font-medium pb-5 text-black">₹23,92,312.19</p>
                </div>
            </div>
        </div>
